...
public class CacheConfig implements CachingConfigurer {
    ...
    public static final String CACHE_NAME_PRICING_RULE = "pricingRule";
    ...
    public CacheManager concurrentMapCacheManager() {
        ...
        return new ConcurrentMapCacheManager(CACHE_NAME_DICTS, CACHE_NAME_USER_PERMISSIONS, CACHE_NAME_STYLE_FORMULA, CACHE_NAME_SIX_DIM_SCHEMA, CACHE_NAME_PRICING_RULE);
    }
